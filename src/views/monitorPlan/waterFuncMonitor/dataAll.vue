<template>
  <div class="pageContent">
        ...
        <div class="el_table_box">
          ...
          >
            ...
            <el-table-column label="水质等级" width="130" align="center" fixed>
              <template slot-scope="scope">
                ...
                <span v-if=" parseInt(scope.row.waterLevel) === 5 ">
                  <i class="category-icon categoryE"></i> 劣Ⅴ类
                </span>
              </template>
            </el-table-column>
            <el-table-column label="文件资料" width="100" align="center">
              <template slot-scope="scope">
                <div>
                  <el-button type="secondBtn" @click="look">查看</el-button>
                </div>
              </template>
            </el-table-column>
            <el-table-column
    ...
    <el-dialog :visible.sync="visiDialogF" width="900px" title="资料查看">
...
export default {
  ...
  methods: {
    ...
    gotoEntry() {
      this.$router.push("/monitorPlan/waterFuncMonitor/dataEntry");
      this.$parent.navClick({ name: "数据录入" });
    },
    uploadFile(file) {
