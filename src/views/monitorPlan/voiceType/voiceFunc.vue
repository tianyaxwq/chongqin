<template>
  <div style="height:100%" class="tapStyle">
          ...
          <div class="currency-mode-wrap">
            <div class="el_table_box" style="height:calc(100% - 34px)">
              ...
              >
                ...
                <el-table-column label="功能区类别" width="120" align="center" prop="receivingWater"></el-table-column>
    ...
    <el-dialog :visible.sync="visiDialog" width="1000px" title="功能区" :before-close="closess">
