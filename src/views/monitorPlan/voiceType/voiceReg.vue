<template>
  <div style="height:100%" class="tapStyle">
      ...
      <div class="currency-mode-wrap">
        <div class="el_table_box" style="height:calc(100% - 34px)">
          ...
          >
            ...
            <el-table-column label="声校准器（型号、编号）" width="180" align="center" prop="pollutionTypes"></el-table-column>
    ...
    <el-dialog :visible.sync="visiDialog" width="1000px" title="区域" :before-close="closess">
...
export default {
  ...
  data() {
    return {
      ...
      formData: {
        monitorName: "", //监测站名
        monitorInstrument: "", //监测仪器
        soundCalibrator: "", //声校准器
        calibrationvalueBeforeMonitoring: "", //监测前校准值
        calibrationvalueAfterMonitoring: "", //监测后校准值
