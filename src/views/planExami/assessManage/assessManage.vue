      ...
      <div class="currency-mode-wrap">
        <div class="el_table_box">
          ...
          >
            ...
            <el-table-column label="指标名称" show-overflow-tooltip prop="indexName" align="center" width="200"></el-table-column>
            <el-table-column prop="code" label="指标编号" width="150" show-overflow-tooltip align="center"></el-table-column>
      ...
      <div class="dialogcontent noScrollX">
        <el-scrollbar style="height:100%">
          <el-form :model="formData" :rules="rules" ref="ruleForm">
            <ul>
              <li class="liblock">
                <p class="lihead">指标信息</p>
                <div class="libody clear">
                  <div class="formDiv">
                    <span class="rCode">指标名称：</span>
                    <div class="layoutBox">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        code: [{ required: true, message: "请输入指标编号", trigger: "blur" }]
      },
  ...
  methods: {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          if (this.isEditor) {
            // 编辑操作
            this.$http
              .put("/planTaskCheck/index", qs.stringify(this.formData))
              .then(res => {
                if (res.data.code == 0) {
            ...
            this.$http
              .post("/planTaskCheck/index", qs.stringify(this.formData))
              .then(res => {
                if (res.data.code == 0) {
                  this.resetForm(formName);
                  this.visiDialog = false;
    ...
    revise(row) {
      ...
      this.vTitle = '编辑指标'
      this.formData.indexName = row.indexName
    ...
    //角色删除
    delet(id) {
      this.globelDelet("/planTaskCheck/index", id, this.searchData);
    },
    //批量删除
    allDelet() {
      this.globelDelet("/planTaskCheck/index", this.ids, this.searchData);
    }
  },
  computed: {
    totalPage() {
