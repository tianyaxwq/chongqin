      ...
      <div class="currency-mode-wrap">
        <div class="el_table_box">
          <el-table border :data="tableData" height="100%">
            ...
            <el-table-column label="计划名称" show-overflow-tooltip prop="planName" align="center" width="200"></el-table-column>
            <el-table-column label="指派人" width="150" show-overflow-tooltip align="center"></el-table-column>
            <el-table-column label="完成时间" prop="thDate" width="150" show-overflow-tooltip align="center"></el-table-column>
