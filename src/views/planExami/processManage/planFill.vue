<template>
  <div class="pageContent">
      ...
      <div class="currency-mode-wrap">
        <div class="el_table_box">
          ...
          >
            ...
            <el-table-column label="完成时间" show-overflow-tooltip prop="thDate" align="center"></el-table-column>
            ...
            <!-- <el-table-column label="填报内容" show-overflow-tooltip prop="thYear" align="center"></el-table-column> -->
    ...
    <el-dialog :visible.sync="visiDialog" width="920px" title="计划填报" :before-close="closess">
...
export default {
  ...
  methods: {
    ...
    //角色删除
    delet(id) {
      this.globelDelet("/planTaskCheck/taskTbForm", id, this.getList);
    },
    //批量删除
    allDelet() {
