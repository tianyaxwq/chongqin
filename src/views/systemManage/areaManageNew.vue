          ...
          <div class="dialogcontent">
                ...
                <div class="dialog-layout">
                    <el-form :model="formData" :rules="formRules" ref="form">
                      <table class="whTable">
                            <tr>
                                 <td width="16.5%"><span  class="rCode">区域名称</span></td>
                                 <td>
                                    <el-form-item  prop="name">
                                        <el-input placeholder="请输入" v-model="formData.name"></el-input>
                                    </el-form-item>
                                 </td>
                                 <td width="16.5%"><span  class="rCode">区域编码</span></td>
                                 <td>
                            ...
                            <tr>
                                 <td width="16.5%"><span  class="rCode">区域级别</span></td>
                                 <td>
                                 ...
                                 <td width="16.5%"><span>父级区域</span></td>
                                 <td>
                             ...
                             <tr>
                                 <td width="16.5%"><span  class="rCode">水质目标等级</span></td>
                                 <td>
                                 ...
                                 <td width="16.5%"><span  class="rCode">排序</span></td>
                                 <td>
...
export default {
  ...
  methods: {
    ...
    //批量删除
    allDelet(){
      this.globelDelet('/SiteManagement/area/delete',this.areaId,this.getTableData);
    },
    init(){
      //获取水质目标等级下拉框数据
    ...
    getTableData(){
       ...
       this.$http.get("/dataHandle/yunliBase/getAreaTree",{
           params:{
       ...
       this.$refs[formName].validate((valid) => {
           if (valid){
                if(this.isEditor){
                    ...
                    this.$http.post("/SiteManagement/area/addOrEdit",params).then(res=>{
                          if(res.data.code == 0){
                             this.$message({
    ...
    areaLevChange(v){
       ...
       this.$http.post("/SiteManagement/area/query",this.paramsObj.GetPageData_P("area",this.currentPage,this.pageSize,[lev],false)).then(res=>{
              if (res.data.code == 0) {
    ...
    editorData(obj){
       ...
       }else if(obj.areaLevel.areaLevelId =='ffbb7faf62044604b7fae55a75303c23'){
         lev=1;
         this.$http.post("/SiteManagement/area/query",this.paramsObj.GetPageData_P("area",this.currentPage,this.pageSize,[lev],false)).then(res=>{
              if (res.data.code == 0) {
                   this.optionFarea=res.data.content.dataList;
       ...
       }else if(obj.areaLevel.areaLevelId== 'ffbb7faf62044604b7fae55a75303c30'){
         lev=2;
         this.$http.post("/SiteManagement/area/query",this.paramsObj.GetPageData_P("area",this.currentPage,this.pageSize,[lev],false)).then(res=>{
              if (res.data.code == 0) {
                   this.optionFarea=res.data.content.dataList;
