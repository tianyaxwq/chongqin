      ...
      <div class="secondary-scroll-content">
        ...
        <div class="secondary-toolbar">
          ...
          <div class="layoutBox" style="width:340px">
           ...
           <el-button @click="searchData"><i class="iconfont icon-shijiantai"></i>评价</el-button>
        ...
        watch:{
           stationInfo(value) {
            if (value.length > 0) {
                ...
                this.init();
                if(this.openPage==='basinn'){
                  this.$router.push("/colligateApplication/analysisReport/waterQualityEvaluationC");
